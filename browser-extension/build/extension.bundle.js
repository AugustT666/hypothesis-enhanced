var hypothesis = (function (exports) {
  ...
  function getChromeAPI(chrome = globalThis.chrome) {
    ...
    return {
      ...
      runtime: {
        ...
        requestUpdateCheck: chrome.runtime.requestUpdateCheck ? chrome.runtime.requestUpdateCheck : null,
  ...
  var buildType = "dev";
  var apiUrl = "chrome-extension://local/api/";
  var authDomain = "localhost";
  var bouncerUrl = "https://hyp.is/";
  var serviceUrl = "chrome-extension://local/";
  ...
  var version = "1.1766.0.7";
  var versionName = "g44a5545.dirty";
  var rawSettings = {
  	buildType: buildType,
  	apiUrl: apiUrl,
  ...
  function detectContentType(document_ = document) {
    function detectChromePDFViewer() {
      ...
      if (typeof chrome !== 'undefined') {
        var _chrome$dom;
        const bodyShadow = (_chrome$dom = chrome.dom) === null || _chrome$dom === void 0 ? void 0 : _chrome$dom.openOrClosedShadowRoot(document.body);
        if (bodyShadow && bodyShadow.querySelector('iframe[type="application/pdf"]')) {
          return {
            type: 'PDF'
          };
        }
  ...
  var isEqualShallow;
  var hasRequiredIsEqualShallow;

  function requireIsEqualShallow () {
  	if (hasRequiredIsEqualShallow) return isEqualShallow;
  	hasRequiredIsEqualShallow = 1;

  	var isPrimitive = requireIsPrimitive();

  	isEqualShallow = function isEqual(a, b) {
  	  if (!a && !b) { return true; }
  ...
  var isEqualShallowExports = requireIsEqualShallow();
  var isShallowEqual = /*@__PURE__*/getDefaultExportFromCjs(isEqualShallowExports);
  ...
  class Extension {
    constructor() {
      ...
      this.firstRun = async extensionInfo => {
        ...
        // In the local (no-auth) build there is no online welcome page to show.
        if (settings.noAuth || settings.localApi) {
          return;
        }
      ...
      async function onTabReplaced(addedTabId, removedTabId) {
        ...
        if (tab !== null && tab !== void 0 && tab.url) {
